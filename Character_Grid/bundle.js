...
/***/ function(module, exports, __webpack_require__) {
	...
	var CharacterApp = __webpack_require__(8);
	var mockData = __webpack_require__(167);
	...
	React.render(React.createElement(CharacterApp, null), document.getElementById("react"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	flux.registerStores({
	  characters: __webpack_require__(4) });

	module.exports = {
	  actions: __webpack_require__(6),

	  getters: __webpack_require__(7) };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nuclear = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.receiveAll = function (characters) {
	  ...
	  results.forEach(function (character) {
	    flux.dispatch("addCharacter", { character: character });
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.characters = [exports.charactersMap, function (charactersMap) {
	  return charactersMap.toList();
	}];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(9);
	var CharacterGrid = __webpack_require__(165);

	var CharacterApp = React.createClass({ displayName: "CharacterApp",

	  render: function render() {
	    return React.createElement(CharacterGrid, null);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flux = __webpack_require__(2);
	var Character = __webpack_require__(1);
	var CharacterItem = __webpack_require__(166);

	var CharacterGrid = React.createClass({ displayName: "CharacterGrid",
	  ...
	  render: function render() {
	    var characterItems = this.state.heroes.map(function (character) {
	      return React.createElement(CharacterItem, { characterData: character });
	    }, this);
	    return React.createElement("div", null, characterItems);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CharacterItem = React.createClass({ displayName: "CharacterItem",

	  render: function render() {
	    var character = this.props.characterData;
	    return React.createElement("div", null, character);
	  }
	});
